...
//   const categoryQuestions = document.getElementById("category").value;       
  ...
  const animalApi = `https://opentdb.com/api.php?amount=10&category=27`; 
  ...
  function changeQuestion() {                                 
    ...
    if (position === dataQuestion.results.length - 1) {       
      ...
      finishSection.innerHTML = `<div class = "finish" style="width: 100%; padding: 100px 0px;  color: black; text-align: center; font-size: 1.3rem;"><h1 class = "mb">Test finished<br> Score = ${score}</h1><a href="../mainindex.html">Play Again</a></div>`
      return
    }
    position++;                                                             
    const typeQuestions = document.getElementById("type").value;            
